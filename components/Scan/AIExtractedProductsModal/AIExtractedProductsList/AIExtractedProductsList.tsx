    ...
    return (
      <View style={[styles.cardContainer, !item.selected && { opacity: 0.4 }]}>
        <Checkbox
          ...
          color={
            item.selected ? (isDark ? theme.white : theme.black) : undefined
          }
        />
...
const createStyles = (theme: Theme, isDark: boolean) => {
  return StyleSheet.create({
    ...
    confidenceHigh: {
      backgroundColor: isDark ? PALETTE.green[900] + '4D' : PALETTE.green[50],
    },
    confidenceMedium: {
      backgroundColor: isDark ? PALETTE.slate[800] : PALETTE.amber[100],
    },
    confidenceLow: {
      backgroundColor: isDark ? PALETTE.red[500] : PALETTE.red[50],
    },
    confidenceHighText: {
      color: isDark ? PALETTE.green[400] : PALETTE.green[700],
    },
